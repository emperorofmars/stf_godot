...
static func read(path: String) -> STF_File:
	...
	ret.binary_version = file.get_32()
	ret.padding_future_use = file.get_32()
...
func write(path: String):
	...
	file.store_32(binary_version)
	file.store_32(padding_future_use)
