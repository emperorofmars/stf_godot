...
func _get_import_options(path: String):
	...
	add_import_option_advanced(TYPE_INT, "stf/animation_handling", 1, PROPERTY_HINT_ENUM, "Prefer Bezier -> Baked -> Simplified,Prefer Baked -> Simplified,Prefer Simplified")
