...
static func arrange_baked_keyframes(context: STF_ResourceHelper, track: Dictionary) -> Array[STFKeyframe]:
	var subtracks = track.get("subtracks", [])
	var len = -1;
...
static func import_value(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling: int = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true, track_type = Animation.TYPE_VALUE):
...
static func import_blendshape(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
...
static func import_position_3d(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
	var method = determine_handling_method(animation_handling, can_import_bezier, track)
	match(method):
		2, 1: # Unbaked Simplified or Baked
...
static func import_rotation_3d(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
	var method = determine_handling_method(animation_handling, can_import_bezier, track)
	match(method):
		2, 1: # Unbaked Simplified or Baked
...
static func import_euler_rotation_3d(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
	var method = determine_handling_method(animation_handling, can_import_bezier, track)
	match(method):
		2, 1: # Unbaked Simplified or Baked
			var track_index := create_track(animation, target, track, Animation.TYPE_ROTATION_3D)
...
static func import_scale_3d(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
	var method = determine_handling_method(animation_handling, can_import_bezier, track)
	match(method):
		2, 1: # Unbaked Simplified or Baked
...
static func import_color(context: STF_ResourceHelper, animation: Animation, target: String, track: Dictionary, start_offset: float, animation_handling = 0, transform_func: OptionalCallable = null, can_import_bezier: bool = true):
	var method = determine_handling_method(animation_handling, can_import_bezier, track)
	match(method):
		2, 1: # Unbaked Simplified or Baked
