...
static func handle_stf_source(context: STF_ImportContext, constraint_holder: CopyTransformModifier3D, target: STF_Bone.ArmatureBone, json_resource: Dictionary, json_source: Array, error_message: String, handle_func: Callable, handle_context: Variant = null):
